...
import edu.usc.cs.util.TopKDatabaseRecorder;
import edu.usc.cs.util.TopKFileRecorder;
...
public class TopKDBBolt extends BaseRichBolt {
    ...
    private TopKFileRecorder recorder;
    ...
    public void prepare(Map conf, TopologyContext context, OutputCollector collector) {
        ...
        recorder = TopKFileRecorder.getInstance("result.txt");
        set = new HashSet();
